...
.DESCRIPTION
    PowerShell Script which supports the OSDCloud environment
.LINK
    https://raw.githubusercontent.com/Sight-Sound-Theatres-SysOps/osd/main/subdomains/osd.sight-sound.dev.ps1
.EXAMPLE
    powershell iex (irm osd.sight-sound.dev)
#>
[CmdletBinding()]
...
if ($WindowsPhase -eq 'WinPE') {
    ...
    step-InstallPowerSHellModule -Name OSDCloud
